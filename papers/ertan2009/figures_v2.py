"""
Ertan 2009 v2 — figures for the v2 replication paper.

Reads papers/ertan2009/results_v2/*_raw.json and writes PDFs to
papers/ertan2009/replicated_v2/figures/.
"""
...
RESULTS_DIR = os.path.join(PAPER_DIR, "results_v2")
FIGURES_DIR = os.path.join(PAPER_DIR, "replicated_v2", "figures")
